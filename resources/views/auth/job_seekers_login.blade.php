          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form method="POST" action="{{ url('job_seekers/update-login') }}" class="login_form">
                        @csrf
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mt-3 mb-lg-4">
                    <button type="button" class="btn btn-primary btn-lg" onclick="validate_job_login_form()">Login</button>
                  </div>
                    <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="{{url('/job_seekers/register')}}"
