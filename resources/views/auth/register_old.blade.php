                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="email" class="form-control @error('mobile_number') is-invalid @enderror" name="mobile_number" value="{{ old('mobile_number') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}"  autocomplete="address" autofocus placeholder="Enter Address"></textarea>
                                ...
                                @enderror
                                 <span class="help-block text-danger address_error"></span>
                            </div>
                        </div>
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select name="country" class="form-control">
                                ...
                                @enderror
                                 <span class="help-block text-danger country_error"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select name="state" class="form-control">
                                ...
                                @enderror
                                 <span class="help-block text-danger city_error"></span>
                            </div>
                        </div>
                        <div class="form-group row">
